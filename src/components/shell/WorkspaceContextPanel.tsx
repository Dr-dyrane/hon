...
export function WorkspaceContextPanel({
  ...
  return (
    <section className="rounded-[30px] bg-system-background/82 px-5 py-5 shadow-[0_18px_40px_rgba(15,23,42,0.06)] md:px-6 md:py-6">
      <div className="flex flex-col gap-4 min-[980px]:flex-row min-[980px]:items-start min-[980px]:justify-between">
        <div className="min-w-0">
          ...
          <h1 className="mt-3 text-[30px] font-semibold tracking-tight text-label md:text-[38px]">
            {title}
          </h1>

          {detail ? (
            <p className="mt-2 text-sm leading-relaxed text-secondary-label md:text-base">
              {detail}
            </p>
          ) : null}
        </div>
