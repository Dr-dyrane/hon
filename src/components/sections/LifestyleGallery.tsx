      ...
      <div className="relative z-10 mx-auto w-full max-w-[1400px]">
        ...
        <div
          className={cn(
            ...
            lightweightMode
              ? "h-auto"
              : "h-[65vh] md:h-[75vh] [perspective:2000px]"
          )}
        >
          {lightweightMode ? (
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="relative w-full overflow-hidden rounded-[26px] shadow-2xl"
              >
                ...
                <div className="pointer-events-none absolute inset-x-0 bottom-0 h-[48%] bg-gradient-to-t from-system-background/94 via-system-background/54 to-transparent dark:from-system-background/88 dark:via-system-background/34 dark:to-transparent" />
                <div className="absolute inset-0 p-6 flex flex-col justify-end sm:p-10">
                  <span className="mb-3 text-[10px] font-bold uppercase tracking-[0.2em] text-label/70">
                    {IMAGES[index]?.tag}
                  </span>
                  <h3 className="text-3xl font-headline font-bold tracking-tight text-label sm:text-4xl">
                    {IMAGES[index]?.title}
                  </h3>
                  <p className="mt-2 max-w-md text-sm text-secondary-label sm:text-base">
            ...
            <>
              ...
              <div className="absolute inset-0 z-40 pointer-events-none flex justify-between px-4 md:px-12">
                <button
                  onClick={prev}
                  className="pointer-events-auto h-full w-1/4"
                  aria-label="Previous"
                />
                <button
                  onClick={next}
